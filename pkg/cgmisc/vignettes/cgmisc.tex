...
{\centering \includegraphics[width=1.0\textwidth]{figure/plot_Manhattan_LD} 
...
We can see that {\tt BICF2P453669} on chromosome 6 (23.34Mb) is the strongest association. Now time to visualize a short fragment of chromosome 6, boyh 1.0Mb downstream and 1.0Mb upstream of the top-associated marker.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
